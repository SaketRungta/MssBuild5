...
#include "SitSubsystem.generated.h"
...
class STEAMINTEGRATIONKIT_API USitSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
#pragma region Session Operations
	 ...
	 */
	void CreateSession(const FCustomSessionSettings& InCustomSessionSettings);
...
#pragma endregion Session Operations On Completion Delegates Callbacks
	 ...
	 */
	FCustomSessionSettings SessionSettingsForTheSessionToCreateAfterDestruction;
